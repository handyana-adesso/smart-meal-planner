...
public static class IngredientEndpoints
{
    ...
    {
        var result = await ingredientService.CreateAsync(recipeId, request, httpContext.GetUserId(), cancellationToken);
    ...
    static async Task<IResult> DeleteAsync(
        ...
        CancellationToken cancellationToken)
    {
        await ingredientService.DeleteAsync(recipeId, ingredientId, httpContext.GetUserId(), cancellationToken);
